package com.example.zhoubo.cstwifi.Wifi;
...
//        this.startScan();
    ...
    public boolean connectWifi(String SSID) {
       ...
       if (mWifiConfiguration==null)
       {
        ...
        if (config != null) {
            connectConfiguration(config.networkId);
            return true;
        } else {
            return false;
        }
...
//然后是一个实际应用方法，只验证过没有密码的情况：
    ...
    private WifiConfiguration IsExsits(String SSID) {
        ...
        //  DebugLog.d(existingConfigs.toString());

        if (existingConfigs == null)
        {
            DebugLog.d("当前wifi列表为空");
            return null;
        }
